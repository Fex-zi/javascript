...
//       //  const neighbour = data[0].borders?.[0];  // Using optional chaining
...
// console.log(
//   getJSON(`https://restcountries.com/v2/name/usa`, `Country not found`)
// );
...
//btn.addEventListener('click', getCountryData('usa')); // wont work cuz of the function argument
